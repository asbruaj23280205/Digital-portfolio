...
<body>
    ...
    <section id="education">
        <div class="section-content">
            <h2>Education</h2>
            <p>Bharathiyar University  - Mech</p>
    ...
    <section id="projects">
        <div class="section-content">
            <h2>Projects</h2>
            <ul>
                <li><a href="#">personal protocol</a></l1>
    ...
    <section id="resume">
       ...
       <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="nm resume.pdf" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
    ...
    <footer>
        <p>&copy; 2025 Yazhinishree S R</p>
    </footer>
